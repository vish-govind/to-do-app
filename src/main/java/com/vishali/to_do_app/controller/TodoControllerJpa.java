...
import com.vishali.to_do_app.repository.TodoRepo;
...
public class TodoControllerJpa {
	...
	public TodoControllerJpa(TodoService todo, AuthenticationService authService, TodoRepo repo) {
		super();
	...
	public String listAllTodos(ModelMap model)
	{
		...
		List<Todo> list_todo = repo.findByUsername(username);
	...
	public String addNewTodo(ModelMap model, @Valid Todo td, BindingResult result)
	{
		...
		repo.save(td);
//		todo.addToDo(username, td.getDescription(),td.getTargetDate(),td.isDone());
